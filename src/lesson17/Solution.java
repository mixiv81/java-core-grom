...
public class Solution {
    ...
    private boolean checkDomen(String address) {
        return address != null && !address.isEmpty() && (address.substring(address.length() - 4).equals(".com")
    ...
    private boolean checkHttp(String address) {
        return address != null && !address.isEmpty() && (address.substring(0, 7).equals("http://") && checkAddress(address.substring(7, address.length() - 4))
