...
public class BanksPractice {
    ...
    static void depositMoney(String[] clients, int[] balances, String client, int money) {
        ...
        //int moneyToDeposit = calcelateDepositAmountAfterCommission(money)
                balances[findClientIndexByName(clients, client)] += calcelateDepositAmountAfterCommission(money);
    }
    ...
    static int calcelateDepositAmountAfterCommission(int money) {
