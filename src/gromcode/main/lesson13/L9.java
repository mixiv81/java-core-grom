...
import gromcode.main.lesson9.hw.User;
import gromcode.main.lesson9.hw.UserRepository;
...
//  проверяем метод "save"
        ...
        System.out.println();
        gromcode.main.lesson15.HW.UserRepositiry.User user10 = new gromcode.main.lesson15.HW.UserRepositiry.User(1, "Andrey", "aaa1");
        gromcode.main.lesson15.HW.UserRepositiry.User user11 = new gromcode.main.lesson15.HW.UserRepositiry.User(2, "Ann", null);
        gromcode.main.lesson15.HW.UserRepositiry.User user12 = new gromcode.main.lesson15.HW.UserRepositiry.User(0, "Ihor", "aaa3");
        gromcode.main.lesson15.HW.UserRepositiry.User user13 = new gromcode.main.lesson15.HW.UserRepositiry.User(4, null, "aaa4");
        gromcode.main.lesson15.HW.UserRepositiry.User user14 = null;
        gromcode.main.lesson15.HW.UserRepositiry.User user15 = new gromcode.main.lesson15.HW.UserRepositiry.User(5, null, "aaa4");
        gromcode.main.lesson15.HW.UserRepositiry.User user16 = new gromcode.main.lesson15.HW.UserRepositiry.User(5, "Ihor", "aaa4");


        gromcode.main.lesson15.HW.UserRepositiry.User[] users10 = new gromcode.main.lesson15.HW.UserRepositiry.User[]{user10, user11, user12, user13, null};
        gromcode.main.lesson15.HW.UserRepositiry.User[] users11 = null;
        gromcode.main.lesson15.HW.UserRepositiry.UserRepository userRepository10 = new gromcode.main.lesson15.HW.UserRepositiry.UserRepository(users10);
        gromcode.main.lesson15.HW.UserRepositiry.UserRepository userRepository1 = new gromcode.main.lesson15.HW.UserRepositiry.UserRepository(users11);
